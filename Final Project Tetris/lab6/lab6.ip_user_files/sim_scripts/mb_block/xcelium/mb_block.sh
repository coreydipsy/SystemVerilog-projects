...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../lab6.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lab6.gen/sources_1/bd/mb_block/ipshared/7698" \
       +incdir+"../../../../lab6.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" \
       +incdir+"../../../../lab6.gen/sources_1/bd/mb_block/ipshared/7698" \
       -input simulate.do
}
