...
HD_PWD='C:/Users/corey/UIUC/ECE/ECE385/Lab4/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_toplevel.tcl -notrace
