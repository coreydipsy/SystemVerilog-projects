...
HD_PWD='C:/Users/corey/UIUC/ECE/ECE385/Lab4/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_toplevel.tcl
